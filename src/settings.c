...
float g_setting_read_part_radius = 0.0f;

void setting_set_part_radius(GLfloat new_fade_factor)
{
	g_setting_read_part_radius = new_fade_factor;
	glProgramUniform1f(g_shprog_draw_particles, 0, g_setting_read_part_radius);
}
