...
/* APSILG header file "random.h"
 * Allow to generate cool pseudo random numbers.
 * Implementations are in "random.c". */

#ifndef __APSILG_header_random__
#define __APSILG_header_random__
...
#endif /* __APSILG_header_random__ */
